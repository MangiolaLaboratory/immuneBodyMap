...
For the planned fitted-model deposit, use the reviewed title, description and
upload checklist in [`ZENODO_SCCOMP_RECORD.md`](ZENODO_SCCOMP_RECORD.md).
...
| sccomp L3 + L0 estimate RDS | Planned companion Zenodo model record (`<ZENODO_DOI_PENDING>`) | `SCCOMP_ESTIMATES_DIR` |
