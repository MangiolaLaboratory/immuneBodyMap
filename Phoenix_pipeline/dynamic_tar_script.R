...
tar_script_expr <-
  substitute({
    tar_script({
      ...
      ## Phoenix setting -----
      hdf5_path = "/hpcfs/groups/phoenix-hpc-mangiola_laboratory/Mangiola_ImmuneAtlas/zenodo/pseudobulk_se.h5ad"
      target_cell_type = CT
      ...
      source(
        '/hpcfs/groups/phoenix-hpc-mangiola_laboratory/chen/HPC_posterior/TAR_SCRIPTS/functions/remove_unwanted_effect.R'
      )
      ### get_adjusted_matrix ------
      source(
        '/hpcfs/groups/phoenix-hpc-mangiola_laboratory/chen/HPC_posterior/TAR_SCRIPTS/functions/get_adjusted_matrix.R'
      )
      ### fit_to_age_monotonic_changes ------
      source(
        '/hpcfs/groups/phoenix-hpc-mangiola_laboratory/chen/HPC_posterior/TAR_SCRIPTS/functions/fit_to_age_monotonic_changes.R'
      )
      ### fit_to_sex_differ_at_decades ------
      source(
        '/hpcfs/groups/phoenix-hpc-mangiola_laboratory/chen/HPC_posterior/TAR_SCRIPTS/functions/fit_to_sex_differ_at_decades.R'
      )
  ...
  }, list(CT = cur_ct)) # cur_ct is the cell type
