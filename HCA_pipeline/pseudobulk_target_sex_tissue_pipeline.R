								...
								map(
									~ .x |>
										...
										select(
											...
											counts, disease, ethnicity_simplified , file_id, sex, tissue_harmonised, sample_
										)
								) 
							)
...
}, ask = FALSE, script = glue("{result_directory}/_targets__sex_tissue.R") )
