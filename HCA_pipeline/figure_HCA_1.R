...
sql_lite_DB = "/vast/projects/RCP/human_cell_atlas/metadata_annotated_0.2.sqlite"
...
plot_proportion_confidence =
  ...
  ggplot(aes(fct_reorder(tissue_harmonised,1- proportion_level_1), proportion, fill =confidence_class)) +
