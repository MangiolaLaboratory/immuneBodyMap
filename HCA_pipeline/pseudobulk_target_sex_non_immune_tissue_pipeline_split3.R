...
}, ask = FALSE, script = glue("{result_directory}/_targets__pseudobulk_non_immune_split3.R"))
...
# tar_read(pseudobulk_df_tissue, store = glue("{result_directory}/_targets__pseudobulk_non_immune_split3"), branches = 1)
# 
# tar_visnetwork(
# 	store = glue("{result_directory}/_targets__pseudobulk_non_immune_split3")
# )
