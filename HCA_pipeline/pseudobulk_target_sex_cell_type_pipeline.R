...
}, ask = FALSE, script = glue("{result_directory}/_targets__sex_cell_type.R") )


job::job({

tar_make_future(
	script = glue("{result_directory}/_targets__sex_cell_type.R"),
	store = glue("{result_directory}/_targets__sex_cell_type"), 
	workers = 200, 
...
# tar_make(
# 	script = glue("{result_directory}/_targets__sex.R"), 
# 	store = glue("{result_directory}/_targets__sex")
# )
# 	
# })
