  ...
  list(
    ...
    tar_target(
      ...
      create_input_cell_counts(
        "/scratch/pawsey1192/zhanchen/Mangiola_ImmuneAtlas/taskforce_shared_folder/pseduobulk/metadata.1.0.10.parquet",
        drop_samples,
        caq_celltype_level_map,
        ethnicity_imputed,
        result_directory
    ...
    tar_target(
      ...
      formula_df$counts[[1]] |> 
        ...
        sccomp_estimate(
          ...
          output_directory = "/scratch/pawsey1192/zhanchen/HPC_sccomp/my_draws", 
    ...
    tar_target(
      ...
      {
        # evaluate result_directory for targets
        final_result_directory = "/scratch/pawsey1192/zhanchen/HPC_sccomp/sccomp_on_cellNexus_1_0_10_2/results"
        print(result_directory)
        
        local_file_name = glue("{final_result_directory}/{formula_df$local_file_name}.rds")
        local_file_name_FIT_FOR_PORTABILITY = glue("{final_result_directory}/{formula_df$local_file_name}_FIT_FOR_PORTABILITY.rds")
        
        # Save draws as monolythic
        attr(estimates, "fit")$save_object(file = local_file_name_FIT_FOR_PORTABILITY) 
        
        # check_rclone_installation()
        # system(glue("rclone copy {local_file_name_FIT_FOR_PORTABILITY} UofA_Box:/Mangiola_ImmuneAtlas/taskforce_shared_folder/sccomp_estimates_1_0_10/"))
        ...
        # check_rclone_installation()
        # system(glue("rclone copy {local_file_name} UofA_Box:/Mangiola_ImmuneAtlas/taskforce_shared_folder/sccomp_on_cellNexus_1_0_10_2/"))
