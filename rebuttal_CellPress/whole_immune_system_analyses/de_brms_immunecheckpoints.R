    ...
    list(
      ...
      tar_target(
        ...
        tribble(
          ...
          "ENSG00000188389", "PDCD1",       "^cd4",
          "ENSG00000188389", "PDCD1",       "^cd8",
          ...
          "ENSG00000163599", "CTLA4",       "^cd4",
          "ENSG00000163599", "CTLA4",       "^cd8",
          "ENSG00000163599", "CTLA4",       "^treg$",
          
          "ENSG00000135480", "LAG3",        "^cd8",
          "ENSG00000135480", "LAG3",        "^treg$",
          "ENSG00000135480", "LAG3",        "^nk$",
          "ENSG00000135480", "LAG3",        "^plasma$",
          
          "ENSG00000135077", "HAVCR2",      "^cd8",
          "ENSG00000135077", "HAVCR2",      "^cd4",
          ...
          "ENSG00000181847", "TIGIT",       "^cd8",
          "ENSG00000181847", "TIGIT",       "^cd4",
          "ENSG00000181847", "TIGIT",       "^treg$",
          "ENSG00000181847", "TIGIT",       "^nk$",
          
          "ENSG00000069275", "BTLA",        "^cd4",
          "ENSG00000069275", "BTLA",        "^cd8",
          "ENSG00000069275", "BTLA",        "^b ",
          ...
          "ENSG00000139187", "KLRG1",       "^cd8",
          "ENSG00000139187", "KLRG1",       "^nk$",
          
          "ENSG00000162594", "CD244",       "^nk$",
          "ENSG00000162594", "CD244",       "^cd8",
          
          "ENSG00000163217", "CD160",       "^nk$",
          "ENSG00000163217", "CD160",       "^cd8",
          
          "ENSG00000105388", "CEACAM1",     "^nk$",
          "ENSG00000105388", "CEACAM1",     "^cd8",
          ...
          "ENSG00000120217", "CD274",       "^cd4",
          "ENSG00000120217", "CD274",       "^cd8",
          "ENSG00000120217", "CD274",       "^treg$",
          "ENSG00000120217", "CD274",       "^nk$",
          "ENSG00000120217", "CD274",       "^b ",
          ...
          "ENSG00000049249", "TNFRSF9",     "^cd8",
          "ENSG00000049249", "TNFRSF9",     "^cd4",
          ...
          "ENSG00000163600", "ICOS",        "^cd4",
          "ENSG00000163600", "ICOS",        "^treg$",
          "ENSG00000163600", "ICOS",        "^cd4 fh em$",
          
          "ENSG00000082397", "TNFRSF4",     "^cd4",
          "ENSG00000082397", "TNFRSF4",     "^cd8",
          "ENSG00000082397", "TNFRSF4",     "^treg$",
          
          "ENSG00000186891", "TNFRSF18",    "^cd4",
          "ENSG00000186891", "TNFRSF18",    "^cd8",
          "ENSG00000186891", "TNFRSF18",    "^treg$",
          
          "ENSG00000139193", "CD27",        "^cd4",
          "ENSG00000139193", "CD27",        "^cd8",
          "ENSG00000139193", "CD27",        "^b ",
          "ENSG00000139193", "CD27",        "^nk$",
          
          "ENSG00000125726", "CD70",        "^cd4",
          "ENSG00000125726", "CD70",        "^cd8",
          "ENSG00000125726", "CD70",        "^b ",
          "ENSG00000125726", "CD70",        "^cdc$",
          "ENSG00000125726", "CD70",        "^pdc$",
          
          "ENSG00000178562", "CD28",        "^cd4",
          "ENSG00000178562", "CD28",        "^cd8",
          
          "ENSG00000177455", "TNFRSF17",    "^plasma$",
          "ENSG00000177455", "TNFRSF17",    "^b ",
          
          "ENSG00000174444", "TNFRSF13B",   "^b ",
          "ENSG00000174444", "TNFRSF13B",   "^plasma$",
          
          "ENSG00000117090", "SLAMF7",      "^nk$",
          "ENSG00000117090", "SLAMF7",      "^cd8",
          "ENSG00000117090", "SLAMF7",      "^b ",
          "ENSG00000117090", "SLAMF7",      "^plasma$",
          
          "ENSG00000182870", "GPRC5D",      "^plasma$",
          
          "ENSG00000143921", "FCRL5",       "^b ",
          "ENSG00000143921", "FCRL5",       "^plasma$",
          
          "ENSG00000091972", "CD200",       "^cdc$",
          "ENSG00000091972", "CD200",       "^pdc$",
          "ENSG00000091972", "CD200",       "^b ",
          "ENSG00000091972", "CD200",       "^cd4",
          "ENSG00000091972", "CD200",       "^cd8"
        )    |> 
