...
job::job({
  ...
  tar_script({
    ...
    list(
      ...
      tar_target(hdf5_path, "/vast/projects/mangiola_immune_map/PostDoc/immuneHealthyBodyMap/pseudobulk_se_v5.h5ad", format = "file"),
      tar_target(
      feature_df ,
      tribble(
        ~ensembl_gene_id,   ~gene_symbol, ~cell_type_unified_ensemble,
        "ENSG00000188389", "PDCD1",       "cd4 naive",
        "ENSG00000188389", "PDCD1",       "cd4 tcm",
        "ENSG00000188389", "PDCD1",       "cd4 th17 em",
        "ENSG00000188389", "PDCD1",       "cd4 th1/th17 em",
        "ENSG00000188389", "PDCD1",       "cd4 th1 em",
        "ENSG00000188389", "PDCD1",       "cd4 th2 em",
        "ENSG00000188389", "PDCD1",       "cd4 fh em",
        "ENSG00000188389", "PDCD1",       "cd8 naive",
        "ENSG00000188389", "PDCD1",       "cd8 tem",
        "ENSG00000188389", "PDCD1",       "cd8 tcm",
        "ENSG00000188389", "PDCD1",       "treg",
        "ENSG00000188389", "PDCD1",       "nk",
        "ENSG00000188389", "PDCD1",       "nkt",
        "ENSG00000188389", "PDCD1",       "mait",
        "ENSG00000188389", "PDCD1",       "tgd",
        "ENSG00000188389", "PDCD1",       "b naive",
        "ENSG00000188389", "PDCD1",       "b memory",
        "ENSG00000188389", "PDCD1",       "plasma",
        "ENSG00000188389", "PDCD1",       "macrophage",
        "ENSG00000188389", "PDCD1",       "cd14 mono",
        "ENSG00000188389", "PDCD1",       "cd16 mono",
        "ENSG00000188389", "PDCD1",       "cdc",
        "ENSG00000188389", "PDCD1",       "pdc",
        
        "ENSG00000163599", "CTLA4",       "cd4 naive",
        "ENSG00000163599", "CTLA4",       "cd4 tcm",
        "ENSG00000163599", "CTLA4",       "cd4 th17 em",
        "ENSG00000163599", "CTLA4",       "cd4 th1/th17 em",
        "ENSG00000163599", "CTLA4",       "cd4 th1 em",
        "ENSG00000163599", "CTLA4",       "cd4 th2 em",
        "ENSG00000163599", "CTLA4",       "treg",
        "ENSG00000163599", "CTLA4",       "cd8 naive",
        "ENSG00000163599", "CTLA4",       "cd8 tem",
        "ENSG00000163599", "CTLA4",       "cd8 tcm",
        
        "ENSG00000135480", "LAG3",        "cd8 tem",
        "ENSG00000135480", "LAG3",        "cd8 tcm",
        "ENSG00000135480", "LAG3",        "treg",
        "ENSG00000135480", "LAG3",        "nk",
        "ENSG00000135480", "LAG3",        "plasma",
        "ENSG00000135480", "LAG3",        "mait",
        "ENSG00000135480", "LAG3",        "tgd",
        
        "ENSG00000135077", "HAVCR2",      "cd8 tem",
        "ENSG00000135077", "HAVCR2",      "cd8 tcm",
        "ENSG00000135077", "HAVCR2",      "cd8 naive",
        "ENSG00000135077", "HAVCR2",      "cd4 th1/th17 em",
        "ENSG00000135077", "HAVCR2",      "cd4 th1 em",
        "ENSG00000135077", "HAVCR2",      "cd4 th17 em",
        "ENSG00000135077", "HAVCR2",      "cd4 th2 em",
        "ENSG00000135077", "HAVCR2",      "treg",
        "ENSG00000135077", "HAVCR2",      "nk",
        "ENSG00000135077", "HAVCR2",      "cdc",
        "ENSG00000135077", "HAVCR2",      "pdc",
        "ENSG00000135077", "HAVCR2",      "macrophage",
        "ENSG00000135077", "HAVCR2",      "cd14 mono",
        "ENSG00000135077", "HAVCR2",      "cd16 mono",
        "ENSG00000135077", "HAVCR2",      "mait",
        "ENSG00000135077", "HAVCR2",      "tgd",
        
        "ENSG00000181847", "TIGIT",       "cd8 tem",
        "ENSG00000181847", "TIGIT",       "cd8 tcm",
        "ENSG00000181847", "TIGIT",       "cd8 naive",
        "ENSG00000181847", "TIGIT",       "cd4 tcm",
        "ENSG00000181847", "TIGIT",       "cd4 th1/th17 em",
        "ENSG00000181847", "TIGIT",       "cd4 th1 em",
        "ENSG00000181847", "TIGIT",       "cd4 th2 em",
        "ENSG00000181847", "TIGIT",       "treg",
        "ENSG00000181847", "TIGIT",       "nk",
        "ENSG00000181847", "TIGIT",       "nkt",
        
        "ENSG00000069275", "BTLA",        "cd4 naive",
        "ENSG00000069275", "BTLA",        "cd4 tcm",
        "ENSG00000069275", "BTLA",        "cd8 naive",
        "ENSG00000069275", "BTLA",        "cd8 tem",
        "ENSG00000069275", "BTLA",        "cd8 tcm",
        "ENSG00000069275", "BTLA",        "b naive",
        "ENSG00000069275", "BTLA",        "b memory",
        "ENSG00000069275", "BTLA",        "macrophage",
        "ENSG00000069275", "BTLA",        "cd14 mono",
        "ENSG00000069275", "BTLA",        "cd16 mono",
        "ENSG00000069275", "BTLA",        "cdc",
        "ENSG00000069275", "BTLA",        "pdc",
        
        "ENSG00000163638", "VSIR",        "macrophage",
        "ENSG00000163638", "VSIR",        "cd14 mono",
        "ENSG00000163638", "VSIR",        "cd16 mono",
        "ENSG00000163638", "VSIR",        "granulocyte",
        "ENSG00000163638", "VSIR",        "cdc",
        "ENSG00000163638", "VSIR",        "pdc",
        
        "ENSG00000139187", "KLRG1",       "cd8 tem",
        "ENSG00000139187", "KLRG1",       "cd8 tcm",
        "ENSG00000139187", "KLRG1",       "nk",
        
        "ENSG00000162594", "CD244",       "nk",
        "ENSG00000162594", "CD244",       "cd8 tem",
        "ENSG00000162594", "CD244",       "cd8 tcm",
        
        "ENSG00000163217", "CD160",       "nk",
        "ENSG00000163217", "CD160",       "cd8 tem",
        
        "ENSG00000105388", "CEACAM1",     "nk",
        "ENSG00000105388", "CEACAM1",     "cd8 tem",
        "ENSG00000105388", "CEACAM1",     "endothelial",
        
        "ENSG00000120217", "CD274",       "cdc",
        "ENSG00000120217", "CD274",       "pdc",
        "ENSG00000120217", "CD274",       "macrophage",
        "ENSG00000120217", "CD274",       "cd14 mono",
        "ENSG00000120217", "CD274",       "cd16 mono",
        "ENSG00000120217", "CD274",       "cd4 tcm",
        "ENSG00000120217", "CD274",       "cd4 th1/th17 em",
        "ENSG00000120217", "CD274",       "cd4 th1 em",
        "ENSG00000120217", "CD274",       "cd4 th17 em",
        "ENSG00000120217", "CD274",       "cd4 th2 em",
        "ENSG00000120217", "CD274",       "cd8 tcm",
        "ENSG00000120217", "CD274",       "cd8 tem",
        "ENSG00000120217", "CD274",       "treg",
        "ENSG00000120217", "CD274",       "nk",
        "ENSG00000120217", "CD274",       "b naive",
        "ENSG00000120217", "CD274",       "b memory",
        
        "ENSG00000197646", "PDCD1LG2",    "cdc",
        "ENSG00000197646", "PDCD1LG2",    "pdc",
        "ENSG00000197646", "PDCD1LG2",    "macrophage",
        "ENSG00000197646", "PDCD1LG2",    "cd14 mono",
        "ENSG00000197646", "PDCD1LG2",    "cd16 mono",
        
        "ENSG00000121594", "CD80",        "cdc",
        "ENSG00000121594", "CD80",        "pdc",
        "ENSG00000121594", "CD80",        "macrophage",
        "ENSG00000121594", "CD80",        "cd14 mono",
        "ENSG00000121594", "CD80",        "cd16 mono",
        "ENSG00000121594", "CD80",        "b naive",
        "ENSG00000121594", "CD80",        "b memory",
        
        "ENSG00000114013", "CD86",        "cdc",
        "ENSG00000114013", "CD86",        "pdc",
        "ENSG00000114013", "CD86",        "macrophage",
        "ENSG00000114013", "CD86",        "cd14 mono",
        "ENSG00000114013", "CD86",        "cd16 mono",
        "ENSG00000114013", "CD86",        "b naive",
        "ENSG00000114013", "CD86",        "b memory",
        
        "ENSG00000049245", "CD276",       "cdc",
        "ENSG00000049245", "CD276",       "pdc",
        "ENSG00000049245", "CD276",       "macrophage",
        "ENSG00000049245", "CD276",       "cd14 mono",
        "ENSG00000049245", "CD276",       "cd16 mono",
        
        "ENSG00000119636", "VTCN1",       "macrophage",
        "ENSG00000119636", "VTCN1",       "cd14 mono",
        "ENSG00000119636", "VTCN1",       "cd16 mono",
        "ENSG00000119636", "VTCN1",       "cdc",
        "ENSG00000119636", "VTCN1",       "pdc",
        
        "ENSG00000131203", "IDO1",        "cdc",
        "ENSG00000131203", "IDO1",        "pdc",
        "ENSG00000131203", "IDO1",        "macrophage",
        "ENSG00000131203", "IDO1",        "cd14 mono",
        "ENSG00000131203", "IDO1",        "cd16 mono",
        
        "ENSG00000196776", "CD47",        "macrophage",
        "ENSG00000196776", "CD47",        "cd14 mono",
        "ENSG00000196776", "CD47",        "cd16 mono",
        "ENSG00000196776", "CD47",        "endothelial",
        
        "ENSG00000198053", "SIRPA",       "macrophage",
        "ENSG00000198053", "SIRPA",       "cd14 mono",
        "ENSG00000198053", "SIRPA",       "cd16 mono",
        "ENSG00000198053", "SIRPA",       "cdc",
        "ENSG00000198053", "SIRPA",       "pdc",
        
        "ENSG00000049249", "TNFRSF9",     "cd8 tem",
        "ENSG00000049249", "TNFRSF9",     "cd8 tcm",
        "ENSG00000049249", "TNFRSF9",     "cd4 tcm",
        "ENSG00000049249", "TNFRSF9",     "cd4 th1/th17 em",
        "ENSG00000049249", "TNFRSF9",     "cd4 th1 em",
        "ENSG00000049249", "TNFRSF9",     "cd4 th2 em",
        "ENSG00000049249", "TNFRSF9",     "treg",
        "ENSG00000049249", "TNFRSF9",     "nk",
        "ENSG00000049249", "TNFRSF9",     "cdc",
        "ENSG00000049249", "TNFRSF9",     "pdc",
        "ENSG00000049249", "TNFRSF9",     "cd14 mono",
        "ENSG00000049249", "TNFRSF9",     "cd16 mono",
        
        "ENSG00000163600", "ICOS",        "cd4 th1/th17 em",
        "ENSG00000163600", "ICOS",        "cd4 th1 em",
        "ENSG00000163600", "ICOS",        "cd4 th2 em",
        "ENSG00000163600", "ICOS",        "cd4 fh em",
        "ENSG00000163600", "ICOS",        "treg",
        
        "ENSG00000082397", "TNFRSF4",     "cd4 tcm",
        "ENSG00000082397", "TNFRSF4",     "cd4 th1/th17 em",
        "ENSG00000082397", "TNFRSF4",     "cd4 th1 em",
        "ENSG00000082397", "TNFRSF4",     "cd4 th2 em",
        "ENSG00000082397", "TNFRSF4",     "cd8 tem",
        "ENSG00000082397", "TNFRSF4",     "cd8 tcm",
        "ENSG00000082397", "TNFRSF4",     "treg",
        
        "ENSG00000186891", "TNFRSF18",    "cd4 tcm",
        "ENSG00000186891", "TNFRSF18",    "cd4 th1/th17 em",
        "ENSG00000186891", "TNFRSF18",    "cd4 th1 em",
        "ENSG00000186891", "TNFRSF18",    "cd4 th2 em",
        "ENSG00000186891", "TNFRSF18",    "cd8 tem",
        "ENSG00000186891", "TNFRSF18",    "cd8 tcm",
        "ENSG00000186891", "TNFRSF18",    "treg",
        
        "ENSG00000139193", "CD27",        "cd4 naive",
        "ENSG00000139193", "CD27",        "cd4 tcm",
        "ENSG00000139193", "CD27",        "cd8 naive",
        "ENSG00000139193", "CD27",        "cd8 tcm",
        "ENSG00000139193", "CD27",        "b naive",
        "ENSG00000139193", "CD27",        "b memory",
        "ENSG00000139193", "CD27",        "nk",
        
        "ENSG00000125726", "CD70",        "cd4 th1/th17 em",
        "ENSG00000125726", "CD70",        "cd4 th1 em",
        "ENSG00000125726", "CD70",        "cd4 th2 em",
        "ENSG00000125726", "CD70",        "cd8 tem",
        "ENSG00000125726", "CD70",        "cd8 tcm",
        "ENSG00000125726", "CD70",        "b memory",
        "ENSG00000125726", "CD70",        "cdc",
        "ENSG00000125726", "CD70",        "pdc",
        
        "ENSG00000178562", "CD28",        "cd4 naive",
        "ENSG00000178562", "CD28",        "cd4 tcm",
        "ENSG00000178562", "CD28",        "cd8 naive",
        "ENSG00000178562", "CD28",        "cd8 tcm",
        "ENSG00000178562", "CD28",        "treg",
        
        "ENSG00000177455", "TNFRSF17",    "plasma",
        "ENSG00000177455", "TNFRSF17",    "b memory",
        
        "ENSG00000174444", "TNFRSF13B",   "b naive",
        "ENSG00000174444", "TNFRSF13B",   "b memory",
        "ENSG00000174444", "TNFRSF13B",   "plasma",
        
        "ENSG00000117090", "SLAMF7",      "nk",
        "ENSG00000117090", "SLAMF7",      "cd8 tem",
        "ENSG00000117090", "SLAMF7",      "cd8 tcm",
        "ENSG00000117090", "SLAMF7",      "b memory",
        "ENSG00000117090", "SLAMF7",      "plasma",
        
        "ENSG00000182870", "GPRC5D",      "plasma",
        
        "ENSG00000143921", "FCRL5",       "b memory",
        "ENSG00000143921", "FCRL5",       "plasma",
        
        "ENSG00000091972", "CD200",       "cdc",
        "ENSG00000091972", "CD200",       "pdc",
        "ENSG00000091972", "CD200",       "b naive",
        "ENSG00000091972", "CD200",       "b memory",
        "ENSG00000091972", "CD200",       "cd4 naive",
        "ENSG00000091972", "CD200",       "cd4 tcm",
        "ENSG00000091972", "CD200",       "cd8 naive",
        "ENSG00000091972", "CD200",       "cd8 tcm"
      )    |> 
          group_by(gene_symbol, cell_type_unified_ensemble) |> 
          tar_group(),
        iteration = "group",
        packages = c( "tidySummarizedExperiment", "targets", "purrr", "dplyr", "stringr"),
      ...
      tar_target(
        ...
        pseudobulk_sample,
        {
          ...
          se = 
            zellkonverter::readH5AD(hdf5_path, use_hdf5 = TRUE, reader = "R")
         ...
         # se = se[((assay(se, "gene_presence") > 0) |> rowSums() > (ncol(se) * 0.95)),,drop=FALSE ]
          ...
          se = 
            ...
            keep_abundant(design = 
                            ...
                            resolve_complete_confounders_of_non_interest(tissue_groups, sex, ethnicity_groups, is_old_individual, cell_type_unified_ensemble) |> 
                            colData() |> 
                            droplevels() |> 
     ...
     - 5 * `ethnicity_groupsJapanese`
      ...
      tar_target(
        ...
        estimates_chunk |> 
          ...
          mutate(brms_fit_adjusted_ethnicity_estimate = map2(brms_fit_adjusted_ethnicity, matching_samples, ~ {
            
            df = .x |> as_tibble()
            if (nrow(df) == length(pseudobulk_sample_id)){
              return(
                df |>
                  select(adjusted___Estimate) |> 
          ...
          mutate(brms_fit_adjusted_tissue_estimate = map2(brms_fit_adjusted_tissue, matching_samples, ~ {
      ...
      tar_target(
        ...
        resources = tar_resources(
          crew = tar_resources_crew("elastic_5")
        )
      ),
